...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script> </head>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="designation" name="designation" aria-describedby="emailHelp" placeholder="Enter la désignation">
  </div>
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="qte" name="qte" placeholder="Enter la quantité">
  </div>
